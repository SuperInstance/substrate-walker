"""
Super Explorer — combines ALL strategies for the most thorough discovery.

Uses:
- 10 strategies (spiral, zigzag, perimeter, etc.)
- 30 seeds (most around the known good ones)
- Multiple positions per seed
- Best lore selection from multiple models
"""
...
def main():
    # Combine top-known-good seeds with random ones
    seeds = [
        800330, 390172, 272801, 270801, 271801,
        800340, 281679, 799840, 415222, 790340,
        801340, 389722, 390232, 271791, 221801,
        # Plus some random
        123456, 654321, 987654, 321654, 111111,
        222222, 333333, 444444, 555555, 666666,
        777777, 888888, 999999, 101010, 202020,
    ]

    print(f"Super Explorer — {len(seeds)} seeds × {len(STRATEGIES)} strategies")
    ...
    out_file = Path(__file__).parent / "super_explorer_results.json"
